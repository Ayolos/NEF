                ...
                <div class="py-8 lg:py-16 px-4 h-max">
                    <div class="pb-8 bg-curr rounded-t-xl p-8 shadow-2xl">
                        ...
                        <div class="flex items-center justify-start gap-4 text-md text-gray-100 pt-6">
                            ...
                            <a href="https://www.linkedin.com/company/nord-%C3%A9quipement-fermetures/" class="hover:text-gray-900">NORD ÉQUIPEMENT FERMETURES</a>
                        </div>
                    </div>
                    <div class="bg-gray-100 p-6 rounded-b-xl shadow-2xl">
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <button type="submit" class="py-3 mx-auto w-full px-5 text-sm font-medium text-center text-white rounded-lg bg-curr sm:w-fit hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-600">Envoyer</button>
                        </form>
                    </div>
                </div>
            </section>
